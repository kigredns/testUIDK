...
local fullText = "<font color='rgb(0, 255, 255)'>Sander</font> " ..
                 ...
                 "<font color='rgb(255, 255, 0)'>Summer!</font> " ..
...
local WindowName = SetProps(MakeElement("Label", WindowConfig.Name, 14), {
	...
	AddConnection(MinimizeBtn.MouseButton1Up, function()
		if Minimized then
			TweenService:Create(MainWindow, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 700, 0, 360)}):Play()
