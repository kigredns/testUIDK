...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		local NotificationFrame = SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(25, 25, 24), 0, 10), {
			...
			MakeElement("Stroke", Color3.fromRGB(0, 255, 255), 1.2),
...
local WindowName = SetProps(MakeElement("Label", WindowConfig.Name, 14), {
    ...
    Text = "<font color='rgb(0, 255, 255)'>Sander</font> <font color='rgb(255, 255, 255)'>XY「 BrookHaven 」</font>" -- Używamy tagów <font color='rgb(R, G, B)'>tekst</font>
})
